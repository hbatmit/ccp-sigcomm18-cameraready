...
\paragrapha{High Bandwidth, Low RTT (S\ref{sec:eval:lowrtt})} We use ns-2 simulations to demonstrate that CCP can be feasible even in ultra-low RTT environments beyond the scenario in \S\ref{sec:eval:whyfold:scale}.
