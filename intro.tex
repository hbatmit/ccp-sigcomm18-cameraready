...
\begin{enumerate}
    ...
    \item {\bf New capabilities:} CCP makes it easier to provide new
      ...
      proposed in the Congestion Manager (CM)~\cite{cm}, and algorithms that require significant computation (e.g., signal processing, machine learning, \etc) using \userspace programming environments. These algorithms are hard to write as window updates on incoming ACKs.
