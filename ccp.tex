...
Figure~\ref{fig:ccp:bbr} shows\footnote{We only implement BBR's bandwidth and RTT probing (PROBE\_BW and PROBE\_RTT) phases. Our implementation is here: \url{github.com/ccp-project/bbr}.}
