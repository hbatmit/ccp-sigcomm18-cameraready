...
\Para{Datapath programs.} CCP's datapath programs are written in a restrictive
...
If an event condition evaluates to true, \eg (in this example) the number of lost packets is
greater than zero, the body of the \ct{when} clause is executed as the corresponding
action.
%
...
The \ct{report} instruction causes 
